...
main() {
  echo "SHIMBOOT: Bootstrap.sh starting..." > /dev/console
  ...
  echo "SHIMBOOT: Creating recovery disable markers..." > /dev/console
  mkdir -p /tmp
  ...
  echo "SHIMBOOT: Automatically booting $target" > /dev/console
